...
const machine = {
  litersOfCoffee: 0,
  fillWithLitersOfCoffee: function(LitersOfRefill) {
    this.litersOfCoffee = this.litersOfCoffee + LitersOfRefill;
  },
  expresso: function() {
  ...
  longCoffee: function() {
    if (this.litersOfCoffee >= 0.15) {
      this.litersOfCoffee = this.litersOfCoffee - 0.15; // this.litersOfCoffee -=0.15
      return true;
    } else {
      return false;
    }
