...
// 1ère manière d'écrire la fonction :
...
// 2ème manière d'écrire la fonction :
// function squareDigits(number){
//   const treatment = number.toString().split("").map(num => num*num).join("");
//   return parseInt(treatment, 10);
// }
